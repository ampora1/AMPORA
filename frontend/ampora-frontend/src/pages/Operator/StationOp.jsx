    ...
    async function loadStations() {
      ...
      try {
        ...
        const res = await fetch(
          `${API_BASE}/api/stations/operator/${operatorId}`
        );
        ...
        const chargers = data.flatMap((station) =>
    ...
    <div className="min-h-screen pt-20 px-8 pb-10 bg-gradient-to-br from-gray-50 via-emerald-50 to-teal-100">
      ...
      <header className="mb-8 w-full">
        ...
        <p className="mt-3 text-slate-600">
          Monitor and manage charging slots in your station.
        </p>
        ...
        <div className="mt-4 flex gap-3 p-4 rounded-xl bg-emerald-50 border border-emerald-200">
          ...
          <ul className="text-sm text-emerald-900 list-disc pl-4 space-y-1">
            ...
            <li>Edit or delete slots</li>
            <li>Monitor charger power and availability</li>
          </ul>
        </div>
      </header>
  ...
  return (
    <>
      ...
      <div className="flex justify-end gap-3 mt-4">
        <button onClick={onReset} className="px-4 py-2 bg-gray-100 rounded">
          Reset
        </button>

        <button onClick={onSave} className="px-4 py-2 bg-emerald-600 text-white rounded">
          Save
        </button>
      </div>
    </>
